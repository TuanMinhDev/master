...
import { Search_SerApp_Param } from "@/packages/types/carservice/SerApp";
...
import { useSerAppLocale } from "../DanhSachCuocHen/components/locale/useSerAppLocale";
import { useSavedState } from "@/packages/ui/base-gridview/components";

export const CuocHen = () => {
  ...
  const fetchData = async () => {
    const resp = await match(isHQ())
      ...
      .otherwise(async () => {
        ...
        const newDataList =
          response.DataList.map((service: any, index: any) => {
            return {
              ...service,
              STT: pageIndex * pageSize + index + 1,
            };
